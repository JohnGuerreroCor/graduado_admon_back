...
public class UsuarioDaoImpl implements IUsuarioDao {
	...
	// REEMPLAZAR LA VISTA DE USURIO POR LA QUE IMPLEMENTA SU APLICATIVO, TENER EN
	// CUENTA LAS VARIBALES DE LA CONSULTA IMPLEMENTADA EN EL ROWMAPPER
	...
	public Usuario buscarUsuario(String username) {
		String sql = "select *, GETDATE() as horaInicioSesion from dbo.usuario_graduado_admin_login ugal "
				...
				+ "inner join persona p on p.per_codigo = ugal.up " + "where  us = ? ";
